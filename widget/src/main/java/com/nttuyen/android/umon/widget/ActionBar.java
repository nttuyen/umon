...
public class ActionBar extends RelativeLayout implements OnClickListener {
    ...
    public ActionBar(Context context, AttributeSet attrs) {
        ...
        mBarView = (RelativeLayout) mInflater.inflate(R.layout.umon_widget_actionbar, null);
        addView(mBarView);
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.UmonWidgetActionBar);
        CharSequence title = a.getString(R.styleable.UmonWidgetActionBar_title);
        if (title != null) {
            setTitle(title);
        }
        a.recycle();
     ...
     * 
     * @param  {@link android.view.View#VISIBLE}, {@link android.view.View#INVISIBLE},
    ...
    /**
     * Adds a list of {@link com.nttuyen.android.umon.widget.ActionBar.Action}s.
    ...
    /**
     * Adds a new {@link com.nttuyen.android.umon.widget.ActionBar.Action}.
    ...
    /**
     * Adds a new {@link com.nttuyen.android.umon.widget.ActionBar.Action} at the specified index.
     * @param action the action to add
    ...
    /**
     * Inflates a {@link android.view.View} with the given {@link com.nttuyen.android.umon.widget.ActionBar.Action}.
     * @param action the action to inflate
     * @return a view
     */
    private View inflateAction(Action action) {
        View view = mInflater.inflate(R.layout.umon_widget_actionbar_item, mActionsView, false);
    ...
    /**
     * A {@link java.util.LinkedList} that holds a list of {@link com.nttuyen.android.umon.widget.ActionBar.Action}s.
     */
    public static class ActionList extends LinkedList<Action> {
    }

    /**
     * Definition of an action that could be performed, along with a umon_widget_icon to
     * show.
     */
            ...
            try {
               mContext.startActivity(mIntent); 
                ...
                Toast.makeText(mContext,
                        mContext.getText(R.string.umon_widget_actionbar_activity_not_found),
